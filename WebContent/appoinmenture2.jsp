                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            <h3 class="text-center mb-60">AI 智能推荐系统</h3>
                            ...
                            <form action="${pageContext.request.contextPath}/doctor/list">
                                ...
                                <label for="name">医院 </label>
                                <input id="name" type="text" name="hospital" placeholder="请输入您要查询的医院" />
                                <label for="pass">科室</label>
                                <input id="name" type="text" name="faculty" placeholder="请输入您要查询的科室" />                                    
