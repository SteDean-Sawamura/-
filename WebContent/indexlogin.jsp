                 ...
                 <!--     <div style="width:300px;height:30px;">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-4">
						<div class="header-top-right-btn f-right">
                     		...
                     		<div class="header-top-right-btn f-right">
                     			<a href="${pageContext.request.contextPath}/comment.jsp"  class="btn">评论</a> 
                     		</div>          
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-xl-6 col-lg-8 col-md-10">
                                    <div class="hero-text">
                                        ...
                                        <div class="hero-slider-btn">
                                            <a data-animation="fadeInLeft" data-delay=".6s" href="${pageContext.request.contextPath}/appoinmenture.jsp" class="btn btn-icon ml-0"><span>+</span>AI 智能推荐系统</a>
                                            <a data-animation="fadeInLeft" data-delay=".6s" href="${pageContext.request.contextPath}/appoinmenture2.jsp" class="btn btn-icon ml-0"><span>+</span>按类搜索</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-5">
                        <div class="section-button text-right d-none d-lg-block pt-80">
                            <a data-animation="fadeInLeft" data-delay=".6s" href="appoinmenture.jsp" class="btn btn-icon ml-0"><span>+</span>预约</a>
                        </div>
                    </div>
                </div>
                <div class="row">
