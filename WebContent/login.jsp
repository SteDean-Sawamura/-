                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            <h3 class="text-center mb-60">从这里登录</h3>
                            ...
                            <form action="${pageContext.request.contextPath}/indexlogin.jsp">
                                ...
                                <button class="btn btn-icon-green w-100" type="submit" id="submt">现在登录</button>
                                <div class="or-divide"><span>or</span></div>
                                <a class="btn theme-btn w-100" href="${pageContext.request.contextPath}/register.jsp">现在注册</a>
                            </form>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="blog-feeds pr-15">
                                <div class="signle-blog-feeds mb-20">
                                    ...
                                    <div class="blog-feeds-text">
                                        ...
                                        <span class="feeds-date">14 July 2022</span>
                                    </div>
                                </div>
                                <div class="signle-blog-feeds mb-20">
                                    <div class="blog-feeds-thumb">
