                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-4">
                        <div class="header-top-right-btn f-right">
                            <a href="appoinmenture.jsp" class="btn">Make Appointment</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            <h3 class="text-center mb-60">智能推荐系统</h3>
                           
							<div style="color:red">AI</div>
							
                            <form action="${pageContext.request.contextPath}/doctor/reco">
                            	<input type="text" name="pageNumber" value="1" style="display:none"/>
                                <label for="name">姓名 </label>
                                <input id="name" type="text" name="patientName" placeholder="请输入您的姓名" />
                                <label for="name">性别</label>
                                <input style="width:15px;height:15px" type="radio" name="sex" checked="checked" value="girl">女
       							<input style="width:15px;height:15px" type="radio" name="sex" value="man">男
                                <label for="pass">您所在地点</label>
                                <input id="name" type="text" name="hospital" placeholder="请输入您所在地点" />
                                <label for="name">您的症状 </label>
                                <input id="name" type="text" name="symptom" placeholder="请输入您的症状" />     
                                <label for="name">您需要的就诊时间 </label>
                                <input style="width:15px;height:15px" type="radio" name="day" checked="checked" value="Monday">周一
       							<input style="width:15px;height:15px" type="radio" name="day" value="Tuesday">周二
       							<input style="width:15px;height:15px" type="radio" name="day" value="Wednesday">周三
       							<input style="width:15px;height:15px" type="radio" name="day" value="Thursday">周四
       							<input style="width:15px;height:15px" type="radio" name="day" value="Friday">周五
       							<input style="width:15px;height:15px" type="radio" name="day" value="Saturday">周六
       							<input style="width:15px;height:15px" type="radio" name="day" value="Sunday">周日
       							<br/>
       							<input style="width:15px;height:15px" type="radio" name="amorpm" checked="checked" value="am">上午
       							<input style="width:15px;height:15px" type="radio" name="amorpm" value="pm">下午
       							<input style="width:15px;height:15px" type="radio" name="amorpm" value="night">晚上
                                <button class="btn btn-icon-green w-100" type="submit" id="submt">Submit Searching</button>
                            </form>
                        </div>
                    </div>
                </div>
