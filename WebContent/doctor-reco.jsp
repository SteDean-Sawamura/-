                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-4">
                        <div class="header-top-right-btn f-right">
                            <a href="appointmenture.jsp" class="btn">智能推荐</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="team-area pt-115 pb-55">
            <div class="container">
                <div class="row">
                	...
                	<c:if test="${empty page.getList()}"><h3>暂无此时间段出诊的医生，请您重新查询!<br/><br/></h3></c:if>
                	 <c:forEach items="${page.getList() }" var="doctor">
                	 <div style="background:#CCC;width:1200px;margin-bottom:20px">
                	 <c:choose>
   						<c:when test="${doctor.rank==1 || doctor.rank==2 ||doctor.rank==3}"> 
         					  <span style="font-size:60px;color:red;margin-left:10px">${doctor.rank }&nbsp;&nbsp;&nbsp;&nbsp;</span>  
   						</c:when>
   						<c:otherwise>
							     <span style="font-size:60px;margin-left:10px">${doctor.rank }&nbsp;&nbsp;&nbsp;&nbsp;</span>
   						</c:otherwise>
					</c:choose>

 
                	<span style="font-size:40px">${doctor.doctorName }&nbsp;&nbsp;&nbsp;</span>
                	<span style="font-size:20px">${doctor.faculty }&nbsp;&nbsp;&nbsp;</span>
                	<span style="font-size:20px">${doctor.doctorTitle }&nbsp;&nbsp;&nbsp;</span>
                	<span style="font-size:20px">${doctor.hospital }&nbsp;&nbsp;&nbsp;</span>
                	<a style="font-size:30px;float:right;margin-right:90px;margin-top:20px" href="${pageContext.request.contextPath}/doctor/details?doctorid=${doctor.id}">+</a>
                	</div>
                	</c:forEach>
	                   ...
	                   <div class="col-xl-4 col-lg-4 col-md-6">
	                       <div class="team-box text-center mb-60">
	                           <div class="team-thumb mb-45 pos-rel">
	                               ...
	                               <c:if test="${doctor.rank==1}">
	                               <img style="margin-top:-150px;margin-left:-10px;margin-right:-80px" width="70px" height="70px" src="${pageContext.request.contextPath}/img/rank/number-one.png"/>
	                               </c:if>
	                               <c:if test="${doctor.rank==2}">
	                               <img style="margin-top:-150px;margin-left:-10px;margin-right:-80px" width="70px" height="70px" src="${pageContext.request.contextPath}/img/rank/r2.jpg"/>
	                               </c:if>
	                               <c:if test="${doctor.rank==3}">
	                               <img style="margin-top:-150px;margin-left:-10px;margin-right:-80px" width="70px" height="70px" src="${pageContext.request.contextPath}/img/rank/r3.jpg"/>
	                               </c:if>
  ...
  //分页
	$("#page").paging({
	    ...
	    callback: function(num) {
	       $(window).attr('location',"${pageContext.request.contextPath }/doctor/reco?pageNumber="+num+"&hospital=${hospital}&symptom=${symptom}&day=${day}&amorpm=${amorpm}");
	    }
	});
